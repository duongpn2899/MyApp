...
public class AdapterGridViewCustom extends BaseAdapter
{
  ...
  //  ArrayList<String> arr;
    ArrayList<com.example.demo.clsTextView> arrTextView;
    public AdapterGridViewCustom(Context myContext, int myLayout, ArrayList<com.example.demo.clsTextView> arrTextView)
    {
   ...
   boolean isX=true;
    private  class ViewHolder{
        com.example.demo.CustomTextView customTextView;
    }
    @Override
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            viewHolder.customTextView=(com.example.demo.CustomTextView) view.findViewById(R.id.custom_textview);
        ...
        com.example.demo.clsTextView tv=arrTextView.get(i);
