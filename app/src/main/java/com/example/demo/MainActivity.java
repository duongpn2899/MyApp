...
//
//        if (Home.song.isPlaying()) {
//            btnSound.setBackgroundResource(R.drawable.sound_on);
//            Home.btnSound.setBackgroundResource(R.drawable.sound_on);
//        }else {
//            btnSound.setBackgroundResource(R.drawable.sound_off);
//            Home.btnSound.setBackgroundResource(R.drawable.sound_off);
//        }
//
